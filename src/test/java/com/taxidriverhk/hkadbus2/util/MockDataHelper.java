...
public final class MockDataHelper {
    ...
    public static final SearchRecordEntity SEARCH_RECORD_ENTITY_2 = SearchRecordEntity.builder()
            ...
            .language(LANGUAGE_EN)
            .build();
    public static final SearchRecordEntity SEARCH_RECORD_ENTITY_3 = SearchRecordEntity.builder()
            .photoShortId(3L)
            .advertisementHashKey("fanta")
            .advertisementName("Fanta")
            .categoryHashKey("drink")
            .categoryName("Drink")
            .busCompany("ctb")
            .busModelHashKey("dennis-dragon-12m")
            .busModelName("Dennis Dragon 12M")
            .routeHashKey("ctb-8x")
            .routeNumber("8X")
            .licensePlateNumber("GM1204")
            .fleetPrefix("8")
            .fleetNumber("12")
            .thumbnail("http://thumbnail.jpg")
            .username("admin")
            .uploadedDate(12346L)
            .tags("fanta,812,gm1204")
            .language(LANGUAGE_EN)
            .build();
